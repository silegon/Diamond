...
class HPCCIPVSCollector(diamond.collector.Collector):

    def __init__(self, config, handlers):
        super(HPCCIPVSCollector, self).__init__(config, handlers)
    ...
    def get_default_config_help(self):
        config_help = super(HPCCIPVSCollector, self).get_default_config_help()
        config_help.update({
